...
var PhysicalFeatures = require('./physical_features.jsx');
var SecondaryCharacteristics = require('./secondaryCharacteristics.jsx');
var Skills = require('./skills.jsx');
var Spells = require('./spells.jsx');
...
var CharacterCreator = React.createClass({
    ...
    handleRankAdd: function(rank) {
      var data = [...this.state.background.ranks, rank];
        this.setState({background:{...this.state.background, ranks:data}});
    },
    handleRankRemove: function(index) {
      var data = [...this.state.background.ranks];
        data.splice(index, 1);
        this.setState({background:{...this.state.background, ranks:data}});
    },
    ...
    render: function() {
      ...
      <div>
        ...
        <Inventory />
        <Notes />
        <h2>Modifiers (Reaction, others?)</h2>
      </div>
        );
  }
});
